<template>
    <div class="flex gap-10">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">Only csv file</p>
        </div>
        <Button @click="uploadFile" :disabled="!file" label="Upload" :loading="loading" />
    </div>

    <div>
        <div role="status" class="w-full flex justify-center h-32 items-center" v-show="loading">
        ...
        <div>
            <DataTable :value="files" tableStyle="min-width: 20rem" v-show="files">
