...
<script setup>
import AdminPieChart from '../components/charts/AdminPieChart.vue'
import AdminBarChart from '../components/charts/AdminBarChart.vue'
...
onMounted(() => {
    store.getAllAlumni(id); //adminId temporary
})
</script>