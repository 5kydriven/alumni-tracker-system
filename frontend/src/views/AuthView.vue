<template>
    <div class="flex bg-white md:flex-row w-full">
        ...
        <form class="flex flex-col justify-center mt-14 sm:mt-0 p-8 w-full lg:w-[450px] mx-auto"
            ...
            <div class="text-center font-semibold p-2 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
                v-show="error">
                {{ errorMessage }}
            </div>
            <div class="py-4">
            ...
            <Button type="submit" label="Sign In" severity="contrast" :loading="loading" />
        </form>
    </div>
</template>
